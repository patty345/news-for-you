...
export const ADD_USER = gql`
    mutation addUser($username: String!, $email: String!, $password: String!, $subscribed: Boolean!) {
        addUser(username: $username, email: $email, password: $password, subscribed: $subscribed) {
            token
            user {
                _id
                username
